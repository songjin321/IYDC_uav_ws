...
bool IsInReigon(cv::RotatedRect &roi_1, cv::RotatedRect &roi_2) {
    ...
    bool IsPointInMatrix_0 = GetCross(Q[0], Q[1], P[0]) * GetCross(Q[2], Q[3], P[0]) >= 0 &&
                             GetCross(Q[1], Q[2], P[0]) * GetCross(Q[3], Q[0], P[0]) >= 0;
    bool IsPointInMatrix_1 = GetCross(Q[0], Q[1], P[1]) * GetCross(Q[2], Q[3], P[1]) >= 0 &&
                             GetCross(Q[1], Q[2], P[1]) * GetCross(Q[3], Q[0], P[1]) >= 0;
    bool IsPointInMatrix_2 = GetCross(Q[0], Q[1], P[2]) * GetCross(Q[2], Q[3], P[2]) >= 0 &&
                             GetCross(Q[1], Q[2], P[2]) * GetCross(Q[3], Q[0], P[2]) >= 0;
    bool IsPointInMatrix_3 = GetCross(Q[0], Q[1], P[3]) * GetCross(Q[2], Q[3], P[3]) >= 0 &&
                             GetCross(Q[1], Q[2], P[3]) * GetCross(Q[3], Q[0], P[3]) >= 0;
...
bool DetectionByColor::detect(cv::Mat &sceneImg, cv::RotatedRect &roi) {
    ...
    //return detectPureObject(sceneImg, roi, cv::Scalar(40, 50, 50),
    //                        cv::Scalar(80, 255, 255));
    return detectBackgroundObject(sceneImg, r_box_1 , roi,
                           cv::Scalar(40, 50, 50),
                           cv::Scalar(80, 255, 255));
